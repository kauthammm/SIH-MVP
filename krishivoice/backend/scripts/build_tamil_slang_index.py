"""
Build TF-IDF index from krishivoice_tamil_slang_10000 (cleaned).
Run: cd d:\\Sih\\krishivoice\\backend && python scripts/build_tamil_slang_index.py
"""
...
CSV_PATH = root_dataset("tamil_slang")
OUT_PATH = KRISHI_ROOT / "data" / "processed" / "tamil_slang_index.joblib"
...
def main() -> None:
    ...
    print(f"Indexed tamil_slang rows: {len(questions):,}")
